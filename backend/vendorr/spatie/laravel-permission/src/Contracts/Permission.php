...
{
    /**
     * A permissions can be applied to roles.
     */
    public function roles(): BelongsToMany;

    /**
     * Find a permissions by its name.
     *
     *
    ...
    /**
     * Find or Create a permissions by its name and guard name.
     */
